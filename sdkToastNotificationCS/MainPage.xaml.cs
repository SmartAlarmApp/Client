...
namespace sdkToastNotificationCS
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        public MainPage()
        {
            ...
            else
            {
                ...
                /*using (var httpClient = new HttpClient())
                {
                    ...
                    var message = new
                    {
                        url = pushChannel.ChannelUri.ToString()
                    };
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        async private void buttonNavigate_Click(object sender, RoutedEventArgs e)
        {
            using (var httpClient = new HttpClient())
            {
                //httpClient.BaseAddress = new Uri("http://alarm.fr.to/");
        ...
        async private void buttonURL_Click(object sender, RoutedEventArgs e)
        {
            using (var httpClient = new HttpClient())
            {
                //httpClient.BaseAddress = new Uri("http://alarm.fr.to/");
